 ...
 * @since 2019-03-20
 */
@TableName("scada_examines_c")
public class ExaminesCVO extends DataEntity<ExaminesCVO> {
     ...
     * meter_i
     */
	@ExcelColumn(value = "meter_i", col = 11)
	@TableField("meter_i")
	private String meterI;
    /**
     * meter_j
     */
	@ExcelColumn(value = "meter_j", col = 12)
	@TableField("meter_j")
	private String meterJ;
    /**
     * meter_k
     */
	@ExcelColumn(value = "meter_k", col = 13)
	@TableField("meter_k")
	private String meterK;
    /**
     * meter_l
     */
	@ExcelColumn(value = "meter_l", col = 14)
	@TableField("meter_l")
	private String meterL;
    /**
     * meter_m
     */
	@ExcelColumn(value = "meter_m", col = 15)
	@TableField("meter_m")
	private String meterM;
    /**
     * meter_n
     */
	@ExcelColumn(value = "meter_n", col = 16)
	@TableField("meter_n")
     ...
     * 收集时间
     */
	@ExcelColumn(value = "收集时间", col = 17)
	@TableField("collect_date")
	private Date collectDate;
    /**
     * 结果
     */
	@ExcelColumn(value = "结果", col = 18)
