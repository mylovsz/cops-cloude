...
import com.cops.scada.base.BlogHandlerInterceptor;
import com.cops.scada.base.MyHandlerInterceptor;
...
public class WebMvcConfigurer extends WebMvcConfigurerAdapter {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        String staticMapping="/static/upload/**";
        String localDirectory = "file:"+path+"/static/upload/";
