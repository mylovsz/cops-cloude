 ...
 */
@Controller
@RequestMapping("/examinesF")
public class ExaminesFController extends BaseController {
    private static final Logger LOGGER = LoggerFactory.getLogger(ExaminesFController.class);
    ...
    public LayerData<QualityExaminesVO> qualityDayKanban(@RequestParam(value = "page", defaultValue = "1") Integer page,
        ...
        List<QualityExaminesVO> qe = examinesFService.getQulityDayKanban(start, end);
        if(qe != null) {
            Collections.sort(qe);
