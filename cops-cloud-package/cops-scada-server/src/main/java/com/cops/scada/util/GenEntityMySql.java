...
//        //执行完成后是否自动打开文件夹
////        gc.setOpen(false);
//        gc.setOutputDir("/Volumes/Me/path/cops_scada/source");
...
//        dsc.setUrl("jdbc:mysql://localhost:3306/cops_scada?useUnicode=true&characterEncoding=utf8&useSSL=false&tinyInt1isBit=true");
//        mpg.setDataSource(dsc);
//
//        // 策略配置
//        StrategyConfig strategy = new StrategyConfig();
//    // strategy.setCapitalMode(true);// 全局大写命名 ORACLE 注意
//        strategy.setTablePrefix(new String[] { "scada_"});// 此处可以修改为您的表前缀
//
//        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
//        strategy.setInclude(new String[] { "scada_product"}); // 需要生成的表
////        strategy.setExclude(new String[]{"sys_user_role","sys_role_menu","sys_group_ur"}); // 排除生成的表
//        // 自定义实体父类
//        strategy.setSuperEntityClass("com.cops.scada.base.DataEntity");
//        // 自定义实体，公共字段
...
//        pc.setParent("com.cops.scada");
//        //pc.setModuleName("produce");
//        pc.setMapper("dao");
