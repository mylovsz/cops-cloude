...
public class CreateTableFiles {
    ...
    public void createFileForProduce(String[] tableNames, Integer type) {
...
//        strategy.setExclude(new String[]{"sys_user_role","sys_role_menu","sys_group_ur"}); // 排除生成的表
        ...
        if (type == 2) {
            strategy.setSuperEntityClass("com.cops.scada.base.TreeEntity");
            // 自定义实体，公共字段
...
//        strategy.setSuperEntityColumns(new String[] { "id" });
        ...
        // 自定义 controller 父类
        strategy.setSuperControllerClass("com.cops.scada.base.BaseController");
