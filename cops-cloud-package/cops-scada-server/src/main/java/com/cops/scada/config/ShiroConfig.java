...
import com.cops.scada.base.CaptchaFormAuthenticationFilter;
import com.cops.scada.realm.AuthRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(@Qualifier("authRealm") AuthRealm authRealm){
        ...
        filterChainDefinitionMap.put("/lackProduce/*","anon");

        filterChainDefinitionMap.put("/device/statelist","anon");

        filterChainDefinitionMap.put("/planDay/list","anon");
        filterChainDefinitionMap.put("/planDay/board","anon");
        ...
        // 产线选型相关
        filterChainDefinitionMap.put("/productInfo/index","anon");
        filterChainDefinitionMap.put("/productInfo/showLed","anon");
        filterChainDefinitionMap.put("/productInfo/showOne","anon");
        filterChainDefinitionMap.put("/productInfo/show","anon");
        filterChainDefinitionMap.put("/productInfo/list","anon");
        filterChainDefinitionMap.put("/productInfo/listHeader","anon");

        filterChainDefinitionMap.put("/quality/detail","anon");
        filterChainDefinitionMap.put("/quality/list","anon");
        filterChainDefinitionMap.put("/hidHome/info","anon");
        filterChainDefinitionMap.put("/showHid","anon");
        filterChainDefinitionMap.put("/home/collect","anon");
        filterChainDefinitionMap.put("/admin/system/log/pvs","anon");
        // end 产线选型相关

        filterChainDefinitionMap.put("/examinesA/*","anon");
        filterChainDefinitionMap.put("/examinesB/*","anon");
        filterChainDefinitionMap.put("/examinesC/*","anon");
        filterChainDefinitionMap.put("/examinesD/*","anon");
        filterChainDefinitionMap.put("/examinesE/*","anon");
        filterChainDefinitionMap.put("/examinesF/*","anon");

        filterChainDefinitionMap.put("/esop/*","anon");
