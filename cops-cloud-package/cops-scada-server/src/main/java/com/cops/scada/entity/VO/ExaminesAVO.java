 ...
 * @since 2019-03-22
 */
@TableName("scada_examines_a")
public class ExaminesAVO extends DataEntity<ExaminesAVO> {
     ...
     */
	@TableField("meter_a")
	@ExcelColumn(value = "meter_a", col = 4)
	private String meterA;
    /**
     * meter_b
     */
	@TableField("meter_b")
	@ExcelColumn(value = "meter_b", col = 5)
	private String meterB;
    /**
     * meter_c
     */
	@TableField("meter_c")
	@ExcelColumn(value = "meter_c", col = 6)
	private String meterC;
    /**
     * meter_d
     */
	@TableField("meter_d")
	@ExcelColumn(value = "meter_d", col = 7)
	private String meterD;
    /**
     * meter_e
     */
	@TableField("meter_e")
	@ExcelColumn(value = "meter_e", col = 8)
	private String meterE;
    /**
     * meter_f
     */
	@TableField("meter_f")
	@ExcelColumn(value = "meter_f", col = 9)
     ...
     */
	@TableField("收集时间")
	@ExcelColumn(value = "收集时间", col = 10)
	private Date collectDate;
    /**
     * 结果
     */
	@ExcelColumn(value = "结果", col = 11)
