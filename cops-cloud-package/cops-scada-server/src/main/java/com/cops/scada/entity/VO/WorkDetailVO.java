...
public class WorkDetailVO extends DataEntity<WorkDetailVO> {
	...
	@Setter
	@Getter
    private Date planDayManufactureDate;
	...
	@Setter
	@Getter
	private Integer planDayPlanNum;

	@Setter
	@Getter
	private Integer planDayState;

	@Setter
	@Getter
	private Integer planDayType;
	...
	@Setter
	@Getter
	private String workUserNickName;
