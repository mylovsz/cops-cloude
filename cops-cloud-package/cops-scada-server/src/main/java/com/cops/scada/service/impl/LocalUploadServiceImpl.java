...
import com.cops.scada.entity.Rescource;
import com.cops.scada.entity.UploadInfo;
import com.cops.scada.service.UploadService;
import com.cops.scada.util.QETag;
import com.cops.scada.util.RestResponse;
import com.cops.scada.exception.MyException;
...
public class LocalUploadServiceImpl implements UploadService {
    ...
    public String upload(MultipartFile file) throws IOException, NoSuchAlgorithmException {
        ...
        StringBuffer sb = new StringBuffer(localUploadPath + "/");
        ...
        rescource.setOriginalNetUrl(file.getOriginalFilename());
    ...
    public String uploadBase64(String base64) {
        ...
        try {
            ...
            StringBuffer ss = new StringBuffer(localUploadPath);
