    ...
    <div class="layui-container">
        ...
        <div class="nav-list">
            ...
            <ul class="layui-nav" lay-filter="">
                <li class="layui-nav-item <#if seriesTypeValue == 1>layui-this</#if>"><a href="${base}/productInfo/showLed?typeValue=1">LED 驱动器</a></li>
                <li class="layui-nav-item <#if seriesTypeValue == 0>layui-this</#if>"><a href="${base}/productInfo/showLed?typeValue=0">HID 镇流器</a></li>
                <li class="layui-nav-item <#if seriesTypeValue == 3>layui-this</#if>"><a href="${base}/productInfo/showLed?typeValue=3">控制器</a></li>
                <li class="layui-nav-item <#if seriesTypeValue == 2>layui-this</#if>"><a href="${base}/productInfo/showLed?typeValue=2">灯具</a></li>
            </ul>
        </div>
    </div>
</div>
<!-- banner部分 -->
<div class="banner product layui-container">
        ...
        <div class="content layui-row">
            <div class="layui-col-xs12 layui-col-sm3 layui-col-md3 layui-col-lg3 content-img">
                ...
                <div class="layui-form layui-collapse">
                    <!-- 第一个系列 -->
                    <div class="layui-inline" style="margin-left: 5px;margin-bottom: 0px;">
                        <label>产品系列: </label>
                    ...
                    <form class="layui-hide layui-form layui-collapse-item" id="searchForm">
                        <!-- 第一个系列 -->
                        <#--<#if seriesList??>-->
            ...
            <div class="layui-col-xs12 layui-col-sm12 layui-col-md12 layui-col-lg12 right">
                <!-- 右侧 -->
                <div placeholder="" class="">
                    <div class="layui-row layui-hide" style="margin: 0px 0px 10px 20px">
...
<script>
    layui.config({
        ...
        firm: 'firm',
        soulTable: 'soulTable'
    }).use(['element', 'form', 'slider', 'table', 'laytpl', 'laydate', 'tag', 'firm', 'soulTable'], function () {
        var firm = layui.firm;
                    ...
                    parseData: function (res) {
                        for (var i = 0; i < res.data.length; i++) {
                            ...
                            for (var j = 0; j < attr.length; j++) {
                                ...
                                res.data[i]['exValue' + attr[j].seriesAttrId] = attr[j].productInfoAttrValue;
                            }
                        }
                        return res;
                    }
                ...
                $.post("${base}/productInfo/listHeader", {seriesId: ${seriesSelectId}}, function (res) {
                    if (res) {
                        ...
                        if (colTitle.length > 0) {
                            ...
                            cols[1] = {fixed: 'left', field: 'shortName', title: '主型号', hide: true};
                            cols[2] = {fixed: 'left', field: 'name', title: '名称', sort: true};
        ...
        form.render();
        form.on('checkbox(input-v-range)', function (data) {
        ...
        form.on('select(selectSeries)', function (data) {
            ...
            console.log(data.othis); //得到美化后的DOM对象
            location.replace('${base}/productInfo/showLed?series=' + data.value + '&typeValue='+seriesTypeValue);
        });
