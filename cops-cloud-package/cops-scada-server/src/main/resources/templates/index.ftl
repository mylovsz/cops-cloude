...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main">
            <a href="${base}/productInfo/index" target="_blank" class="logo">Lumlux</a>
            <!-- 显示/隐藏菜单 -->
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item layui-hide">
                    <select name="systemTag" lay-verify="">
                        <option value="">全部</option>
                        <option value="systemHid" selected>HID</option>
                        <option value="systemLed">LED</option>
                    </select>
                </li>
    ...
    <div class="layui-body layui-form">
        <div class="layui-tab marg0" lay-filter="bodyTab" id="top_tabs_box">
            <ul class="layui-tab-title top_tab" id="top_tabs">
                <li class="layui-this" lay-id=""><div id="divHome"><i class="iconfont icon-computer"></i> <cite>首页</cite></div></li>
            </ul>
            <ul class="layui-nav closeBox">
                <li class="layui-nav-item">
                    <a href="javascript:"><i class="iconfont icon-caozuo"></i>操作</a>
                    <dl class="layui-nav-child">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                    <iframe id="iframeHome" src="${base}/hidHome"></iframe>
    ...
    <div class="layui-footer footer">
        <p>${site.powerby}<a style="margin-left: 10px" href="http://www.beian.gov.cn" target="_blank">${site.record}</a></p>
    </div>
</div>
<script>
    var baseUrl = "${base}";
