...
<fieldset class="layui-elem-field">
  <legend>工时详情检索</legend>
  <div class="layui-field-box">
    <form class="layui-form" id="searchForm">
    <div class="layui-inline" style="margin-left: 15px">
            <label>加工开始时间:</label>
                <div class="layui-input-inline">
                    <input type="text" name="s_beginStartDate" id="beginStartDate" lay-verify="date"  autocomplete="off" class="layui-input">
                </div>
                <span>-</span>
                <div class="layui-input-inline">
                    <input type="text" name="s_endStartDate" id="endStartDate" lay-verify="date"  autocomplete="off" class="layui-input">
                </div>
    </div>
    <div class="layui-inline" style="margin-left: 15px">
            <label>加工结束时间:</label>
...
<script>
    layui.use(['layer','form','table','laydate'], function() {
        ...
        var t = {
            ...
            cols: [[
                {type:'checkbox'},
                {field:'reimbursedTime', title: '补偿时间'},
                {field:'startWorkUserNum', title: '加工人数'},
                {field:'startInNum', title: '半成品投料'},
                {field:'startFinishNum', title: '计划完成数量'},
                ...
                {field:'endQuantityRemarks', title: '备注'},
                {field:'endScrapCount', title: '报废数量'},
                {field:'endScrapReason', title: '报废理由'},
                {field:'endScrapRemarks', title: '报废备注'},
                {field:'endRepairCount', title: '返修数量'},
                {field:'endRepairReason', title: '返修原因'},
                {field:'endRepairRemark', title: '返修备注'},
                ...
                {field:'delFlag',    title: '工时详情状态',width:'12%',templet:'#userStatus'},
