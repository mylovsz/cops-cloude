...
<form class="layui-form" style="width:80%;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="reimbursedTime"  placeholder="请输入补偿时间">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="startWorkUserNum"  placeholder="请输入加工人数">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="startFinishNum"  placeholder="请输入计划完成数量">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    layui.use(['form','jquery','layer','laydate'],function(){
        ...
        form.on("submit(addWorkDetail)",function(data){
            ...
            $.post("${base}/workDetail/add",data.field,function(res){
