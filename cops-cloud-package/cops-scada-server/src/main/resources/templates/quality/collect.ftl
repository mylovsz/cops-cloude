        ...
        <div class="layui-col-sm6 layui-col-md3">
            <div class="layui-card">
                <div class="layui-card-header">
                    总数量
                    <span class="layui-badge layui-bg-blue layuiadmin-badge">目标</span>
                </div>
                <div class="layui-card-body layuiadmin-card-list">
                    <p class="layuiadmin-big-font">12345</p>
                    <p>
                        工单数
                        <span class="layuiadmin-span-color">3<i
            ...
            <div class="layui-card">
                <div class="layui-card-header">
                    ...
                    <div class="layui-btn-group layuiadmin-btn-group">
                        ...
                        <a id="qualityMore" href="javascript:;" class="layui-hide layui-btn layui-btn-primary layui-btn-xs">更多</a>
                    </div>
                </div>
                <div class="layui-card-body">
                    <div class="layui-row layui-col-space10">
                        ...
                        <div class="layui-col-xs12 layui-col-sm6">
                            <div class="layuiadmin-card-text">
                                <div class="layui-text-top"><i class="layui-icon layui-icon-form"></i><a class="mylayui-tab-new"
                                            href="${base}/examinesB/list">初检数据</a></div>
                                <div class="mylayui-text-center">
                                    <table id="quality-day-examines-b" lay-filter="test"></table>
                                </div>
                                <p class="layui-text-bottom"><a
                                            href="${base}/examinesB/list"">品质报告</a><span class="qualityDayShow">7 天前</span>
                                </p>
                            </div>
                        </div>
                        <div class="layui-col-xs12 layui-col-sm6">
                            <div class="layuiadmin-card-text">
                                ...
                                <p class="layui-text-bottom"><a href="${base}/examinesC/list">品质报告</a><span class="qualityDayShow">7 天前</span>
                                </p>
                            </div>
                        </div>
                        <div class="layui-col-xs12 layui-col-sm6">
                            <div class="layuiadmin-card-text">
                                ...
                                <p class="layui-text-bottom"><a href="${base}/examinesD/list"">品质报告</a><span class="qualityDayShow">7 天前</span>
                                </p>
                            </div>
                        </div>
                        <div class="layui-col-xs12 layui-col-sm6">
                            <div class="layuiadmin-card-text">
                                ...
                                <p class="layui-text-bottom"><a href="${base}/examinesE/list">品质报告</a><span class="qualityDayShow">7 天前</span>
                                </p>
                            </div>
                        </div>
                        <div class="layui-col-xs12 layui-col-sm6">
                            <div class="layuiadmin-card-text">
                                ...
                                <p class="layui-text-bottom"><a href="${base}/examinesF/list">品质报告</a><span class="qualityDayShow">7 天前</span>
                                </p>
                            </div>
                        </div>
                    </div>
...
<script type="text/html" id="planRateGoing">
    ...
    {{#  } else { }}
    <div class="layui-progress layui-progress-big" lay-showPercent="yes" style="margin-top: 5px">
        <div class="layui-progress-bar layui-bg-green" lay-percent="{{ ((d.statisticsPackage/d.planQuantity*100).toFixed(2)+"%") }}"></div>
    </div>
...
<script>
    ...
    layui.use(['layer', 'form', 'jquery', 'table', 'laydate', 'element'], function () {
        ...
        var planTable = {
            ...
            method: 'post',
            where: {s_beginCollectDate: dateFtt("yyyy-MM-dd",dateMonth), s_endCollectDate: dateFtt("yyyy-MM-dd",dateCurrent)},
            ...
            cols: [[
                ...
                {title: '工单进度', align: "center", width: 200, templet: '#planRateGoing'},
        ...
        var qualityDayExaminesA = {
            ...
            cols: [[
                {field: 'planSn', width: 70, title: '工单'},
                {field: 'productSn', width: 135, title: '产品类型'},
                {field: 'produceCount', title: '数量'},
                {field: 'produceError', title: '异常'},
