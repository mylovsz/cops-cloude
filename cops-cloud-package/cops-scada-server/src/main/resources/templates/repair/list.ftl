...
<fieldset class="layui-elem-field">
    <legend>维修管理检索</legend>
    <div class="layui-field-box">
        <form class="layui-form" id="searchForm">
            <div class="layui-inline" style="margin-left: 15px">
                <label>维修单编号:</label>
                <div class="layui-input-inline">
                    <input type="text" value="" name="s_sn" placeholder="请输入维修单编号" class="layui-input search_input">
                </div>
            </div>
            <div class="layui-inline" style="margin-left: 15px">
                <label>产品类型:</label>
            ...
            <div class="layui-inline" style="margin-left: 15px">
                <label>不良代码:</label>
                <div class="layui-input-inline">
                    <select name="s_faultCode" lay-search>
            ...
            <div class="layui-inline" style="margin-left: 15px">
                <label>送修时间:</label>
                <div class="layui-input-inline">
                    <input type="text" name="s_beginFaultDate" id="beginFaultDate" lay-verify="date" autocomplete="off"
                           class="layui-input">
                </div>
                <span>-</span>
                <div class="layui-input-inline">
                    <input type="text" name="s_endFaultDate" id="endFaultDate" lay-verify="date" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-inline" style="margin-left: 15px">
                <label>维修时间:</label>
                <div class="layui-input-inline">
                    <input type="text" name="s_beginRepairDate" id="beginRepairDate" lay-verify="date"
                           autocomplete="off" class="layui-input">
                </div>
                <span>-</span>
                <div class="layui-input-inline">
                    <input type="text" name="s_endRepairDate" id="endRepairDate" lay-verify="date" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-inline" style="margin-left: 15px">
                <label>取回时间:</label>
                <div class="layui-input-inline">
                    <input type="text" name="s_beginTakeDate" id="beginTakeDate" lay-verify="date" autocomplete="off"
                           class="layui-input">
                </div>
                <span>-</span>
                <div class="layui-input-inline">
                    <input type="text" name="s_endTakeDate" id="endTakeDate" lay-verify="date" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-inline" style="margin-left: 15px">
            ...
            <div class="layui-inline" style="margin-left: 15px">
                <label>责任部门-部门:</label>
                <div class="layui-input-inline">
                    <select name="s_responsibleDepartment" lay-search>
            ...
            <div class="layui-inline">
                <a class="layui-btn layui-btn-normal" data-type="addRepair">添加维修管理</a>
            </div>
        </form>
    </div>
</fieldset>
...
<script>
    layui.use(['layer', 'form', 'table', 'laydate'], function () {
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'edit') {
                var editIndex = layer.open({
                    title: "编辑维修管理",
                    type: 2,
                    content: "${base}/repair/edit?id=" + data.id,
        ...
        var t = {
            ...
            cols: [[
                {type: 'checkbox'},
                {field: 'sn', title: '维修单编号'},
                {field: 'faultCode', title: '不良代码', templet: '#faultCode'},
                {field: 'faultAppearance', title: '不良现象'},
                {
                    field: 'faultDate',
                    title: '送修时间',
                    templet: '<div>{{ layui.laytpl.toDateString(d.faultDate,"yyyy-MM-dd") }}</div>',
                    unresize: true
                },
                ...
                {field: 'repairWay', title: '维修方案'},
                {
                    field: 'repairDate',
                    title: '维修时间',
                    templet: '<div>{{ layui.laytpl.toDateString(d.repairDate,"yyyy-MM-dd") }}</div>',
                    unresize: true
                },
                {field: 'takeRemark', title: '取回备注'},
                {
                    field: 'takeDate',
                    title: '取回时间',
                    templet: '<div>{{ layui.laytpl.toDateString(d.takeDate,"yyyy-MM-dd") }}</div>',
                    unresize: true
                },
                {field: 'state', title: '状态', templet: '#state'},
                {field: 'responsibleDepartment', title: '责任部门-部门', templet: '#responsibleDepartment'},
