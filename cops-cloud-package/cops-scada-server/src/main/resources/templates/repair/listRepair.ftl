    ...
    <div class="layui-field-box">
        <form class="layui-form" id="searchForm">
            ...
            <div class="layui-inline" style="margin-left: 15px">
                <label>产品编号:</label>
                <div class="layui-input-inline">
                    <input type="text" value="" name="s_produce_sn" placeholder="请输入产品编号" class="layui-input search_input">
                </div>
            </div>
            <div class="layui-inline" style="margin-left: 15px">
                <label>产品类型:</label>
...
<script>
    layui.use(['layer', 'form', 'table', 'laydate'], function () {
        ...
        var t = {
            ...
            where: {s_beginRepairDate:layui.laytpl.toDateString(searchStartDate,"yyyy-MM-dd HH:mm:ss")},
            method: 'post',
            toolbar: true,
            ...
            cols: [[
                ...
                {fixed: 'right',fixed: 'right', title: '操作', width: '10%', align: 'center', toolbar: '#barDemo'}
            ]]
        };
        table.render(t);
        ...
        var active = {
            ...
            exportExcel: function () {
                /*var downurl = "${base}/repair/exportExcel?sn="+$("#sn").val()
                    + "&s_productType=" + $("#productType").val()
                    + "&s_produce_sn=" + $("#produce_sn").val()
                    + "&s_faultCode=" + $("#faultCode").val()
                    ...
                    + "&s_state=" + $("#state").val()
                    + "&s_responsibleDepartment=" + $("#responsibleDepartment").val()
                    + "&s_result=" + $("#result").val();*/
                var downurl = "${base}/repair/exportExcel?s_beginFaultDate="+$("#beginFaultDate").val()
                    + "&s_endFaultDate=" + $("#endFaultDate").val();
                window.open(downurl);
            }
        };
