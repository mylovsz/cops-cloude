...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" lay-verify="required" name="name" id="s_name" value = "" >
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">配置内容</label>
        <div class="layui-input-block">
            <textarea type="layui-textarea" class="layui-textarea" style="height: 300px;" name="content" id="s_content"></textarea>
            <button type="button" class="layui-btn" id="btndefult">默认</button>
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="version" id="s_version" value = "v1.0" >
        </div>
    </div>
...
<script>
    layui.use(['form','jquery','layer'],function(){
        ...
        form.on("submit(addKanban)",function(data){
            ...
            $.post("${base}/kanban/add",
                data.field,
                function(res){
                layer.close(loadIndex);
                if(res.success){
                    parent.layer.msg("看板配置添加成功！",{time:1000},function(){
