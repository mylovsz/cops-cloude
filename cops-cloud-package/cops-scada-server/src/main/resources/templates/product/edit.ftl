...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" value="${product.sn}" name="sn" lay-verify="required"
                   placeholder="请输入产品编号">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" value="${product.name}" name="name" lay-verify="required"
                   placeholder="请输入产品名称">
        ...
        <div class="layui-input-block">
            <select name="type" lay-verify="required" lay-search>
                ...
                <@my type="scada_product_type">
                    <#list result as r>
                        <option value="${r.value}"  <#if (product.type == r.value)> selected="" </#if>  >${r.label}</option>
                    </#list>
                </@my>
            </select>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <div id="introduction">${product.introduction}</div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" value="${product.bom}" name="bom" lay-verify="required"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="hidden" class="layui-input" name="attachment" id="attachment" value="${product.attachment}">
        ...
        <div class="layui-input-block">
            <select name="state" lay-verify="required" lay-search>
                ...
                <@my type="scada_product_state">
                    <#list result as r>
                        <option value="${r.value}"  <#if (product.state == r.value)> selected="" </#if>  >${r.label}</option>
                    </#list>
                </@my>
            </select>
...
<script>
    layui.use(['form', 'jquery', 'layer', 'upload'], function () {
        ...
        form.on("submit(addProduct)", function (data) {
            ...
            //给角色赋值
            $.post("${base}/product/edit", data.field, function (res) {
