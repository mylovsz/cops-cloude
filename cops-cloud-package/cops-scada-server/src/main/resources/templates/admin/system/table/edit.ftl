...
<div class="detail-body" id="fieldForm" style="display: none">
    <form class="layui-form" style="width:90%;" id="myform">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="type" lay-search="" lay-verify="typeCheck" lay-verType="tips" lay-filter="typeFilter" lay-search>
        ...
        <div class="layui-form-item" id="selectDoforDiv">
            ...
            <div class="layui-input-block" id="doforSelect">
                <select name="dofor" lay-verify="required" lay-verType="tips" lay-filter="doforSelect" lay-search>
