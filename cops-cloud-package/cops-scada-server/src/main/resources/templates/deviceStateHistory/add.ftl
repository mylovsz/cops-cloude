...
<head>
    <meta charset="utf-8">
    <title>设备状态历史记录添加--${site.name}</title>
...
<form class="layui-form" style="width:80%;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <textarea name="sn" lay-verify="required" placeholder="请输入资产编号" class="layui-textarea"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    layui.use(['form','jquery','layer'],function(){
        ...
        form.on("submit(addDeviceStateHistory)",function(data){
            ...
            $.post("${base}/deviceStateHistory/add",data.field,function(res){
                layer.close(loadIndex);
                if(res.success){
                    parent.layer.msg("设备状态历史记录添加成功！",{time:1000},function(){
