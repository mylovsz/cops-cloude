  ...
  <div class="layui-field-box">
    <form class="layui-form" id="searchForm">
        ...
        <div class="layui-inline" style="margin-left: 15px">
            <label>产品类型:</label>
            <div class="layui-input-inline">
                <select name="s_productType" id="s_productType" lay-filter="s_productType" lay-filter="s_planId" lay-search>
...
<script>
    ...
    layui.use(['layer','form','table','laydate'], function() {
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'edit'){
                var editIndex = layer.open({
                    title : "编辑初检耐压",
                    type : 2,
                    content : "${base}/examinesD/edit?id="+data.id,
            ...
            if(obj.event === "del"){
                layer.confirm("你确定要删除该初检耐压么？",{btn:['是的,我确定','我再想想']},
                        function(){
                            $.post("${base}/examinesD/delete",{"id":data.id},function (res){
                                if(res.success){
        ...
        var active={
            addExaminesD : function(){
                var addIndex = layer.open({
                    title : "添加初检耐压",
                    type : 2,
                    content : "${base}/examinesD/add",
            ...
            removeDup: function () {
                ...
                layer.confirm(info, {btn: ['是的,我确定', '我再想想']},
                    function () {
                        ...
                        $.post("${base}/examinesD/removeDup", {"productSN": produceSN}, function (res) {
            ...
            exportExcel: function () {
                ...
                var downurl = "${base}/examinesD/exportExcel?s_planId=" + s_planId
