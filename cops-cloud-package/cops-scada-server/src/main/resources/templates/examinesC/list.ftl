...
<script>
    ...
    layui.use(['layer', 'form', 'table', 'laydate'], function () {
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'edit') {
                var editIndex = layer.open({
                    title: "编辑初检耐压",
                    type: 2,
                    content: "${base}/examinesC/edit?id=" + data.id,
            ...
            if (obj.event === "del") {
                layer.confirm("你确定要删除该初检耐压么？", {btn: ['是的,我确定', '我再想想']},
                    function () {
                        $.post("${base}/examinesC/delete", {"id": data.id}, function (res) {
                            if (res.success) {
        ...
        var active = {
            addExaminesC: function () {
                var addIndex = layer.open({
                    title: "添加初检耐压",
                    type: 2,
                    content: "${base}/examinesC/add",
            ...
            removeDup: function () {
                ...
                layer.confirm(info, {btn: ['是的,我确定', '我再想想']},
                    function () {
                        ...
                        $.post("${base}/examinesC/removeDup", {"productSN": produceSN}, function (res) {
            ...
            exportExcel: function () {
                ...
                var downurl = "${base}/examinesC/exportExcel?s_planId=" + s_planId
