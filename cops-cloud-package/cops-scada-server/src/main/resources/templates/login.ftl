...
<head>
    ...
    <link rel="icon" href="${base}/static/images/app.ico">
...
<div class="login">
    <form class="layui-form" action="${base}/login/main" method="post">
        ...
        <div class="layui-form-item">
            <input autofocus="autofocus" class="layui-input" name="username" value="" placeholder="请输入用户名" lay-verify="required" type="text" autocomplete="off">
        </div>
        <div class="layui-form-item">
...
<script>
    layui.use(['layer', 'form'], function() {
        ...
        $(document).ready(function() {
            var srcBgArray = ["${base}/static/images/login/timg.jpg",
                "${base}/static/images/login/chun.jpg",
                "${base}/static/images/login/xia.jpg",
                "${base}/static/images/login/qiu.jpg",
                "${base}/static/images/login/dong.jpg"];
