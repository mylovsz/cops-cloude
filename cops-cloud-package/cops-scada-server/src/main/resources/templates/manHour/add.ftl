...
<form class="layui-form" style="width:80%;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="startInCount"  placeholder="请输入半成品投料">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="startFinishCount"  placeholder="请输入计划完成数量">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="text" name="startDate" id="startDate"   lay-verify="date" placeholder="请选择加工开始时间" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="endQuantityRemarks"  placeholder="请输入合格备注">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="endRepairCount"  placeholder="请输入返工数量">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="endRepairReason"  placeholder="请输入返工原因">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="endRepairRemark"  placeholder="请输入返工备注">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="text" name="endDate" id="endDate"   lay-verify="date" placeholder="请选择加工结束时间" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
...
<script>
    layui.use(['form','jquery','layer','laydate'],function(){
        ...
        form.on("submit(addManHour)",function(data){
            ...
            $.post("${base}/manHour/add",data.field,function(res){
                layer.close(loadIndex);
                if(res.success){
                    parent.layer.msg("工时管理添加成功！",{time:1000},function(){
