                ...
                <form class="layui-form" id="searchForm">
                    <div class="layui-inline" style="margin-left: 15px">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" value="" name="s_name" placeholder="请输入子系列名称" class="layui-input search_input">
                        </div>
                    </div>
    ...
    layui.use(['layer','form','table','laydate'], function() {
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'cognate'){
                var cognateIndex = layer.open({
                    title : "关联属性",
                    type : 2,
                    content : "${base}/seriesAttr/cognate?id="+data.id+"&typeValue="+seriesTypeValue,
        ...
        var t = {
            ...
            cols: [[
                ...
                {field:'name', title: '子系列名称'},
                {field:'nameEn', title: '子系列名称（英文）'},
        ...
        var active={
            addSeries : function(){
                var addIndex = layer.open({
                    title : "添加系列",
                    type : 2,
                    content : "${base}/series/add?typeValue="+seriesTypeValue,
