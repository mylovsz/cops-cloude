...
<form class="layui-form" style="width:80%;">
    ...
    <fieldset class="my-field-header layui-elem-field layui-field-title">
        <legend><div class="my-field-header-text">工单信息</div></legend>
    </fieldset>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <label class="my-form-label">${planDay.planNum}</label>
        </div>
    </div>
    <#--<div class="layui-form-item">-->
        <#--<label class="layui-form-label">计划数量</label>-->
        <#--<div class="layui-input-block">-->
            <#--<input type="text"  class="layui-input layui-disabled" value="${planDay.planNum}" name="planNum" placeholder="请输入计划数量">-->

        <#--</div>-->
    <#--</div>-->
    <fieldset class="my-field-header layui-elem-field layui-field-title">
        <legend><div class="my-field-header-text">产量相关</div></legend>
    </fieldset>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" value="${(planDay.manufactureNum == null)?string(totalWorkDetailVO.totalQuantityCount,planDay.manufactureNum)}" name="manufactureNum"
                   placeholder="请输入制造数量">
        </div>
    </div>

    <#--<div class="layui-form-item">-->
        <#--<label class="layui-form-label">实际产出数量</label>-->
        <#--<div class="layui-input-block">-->
    ...
    <fieldset class="my-field-header layui-elem-field layui-field-title">
        <legend><div class="my-field-header-text">人力工时</div></legend>
    </fieldset>

    <div class="layui-form-item">
        <label class="layui-form-label">制造人数</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input" value="${(planDay.manufactureStaffs==null)?string(totalWorkDetailVO.totalWorkUserNum, planDay.manufactureStaffs)}" name="manufactureStaffs"
                   placeholder="请输入制造人数">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" value="${(planDay.manufactureTimes==null)?string(totalWorkDetailVO.totalWorkTime, planDay.manufactureTimes)}" name="manufactureTimes"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" value="${(planDay.workTime=null)?string(totalWorkDetailVO.totalWorkTime, planDay.workTime)}" name="workTime" placeholder="请输入上班工时">
        ...
        <div class="layui-input-block">
            <select name="state" lay-verify="required" lay-search>
                ...
                <@my type="scada_plan_day_state">
                    <#list result as r>
                        <option value="${r.value}"  <#if (1 == r.value)> selected="" </#if>  >${r.label}</option>
                    </#list>
                </@my>
            </select>
...
<script>
    layui.use(['form', 'jquery', 'layer', 'laydate'], function () {
        ...
        form.on("submit(addPlanDay)", function (data) {
            ...
            //给角色赋值
            $.post("${base}/planDay/reportWork", data.field, function (res) {
