...
<script>
    ...
    layui.use(['layer', 'form', 'table', 'laydate'], function () {
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'edit') {
                var editIndex = layer.open({
                    title: "编辑初检耐压",
                    type: 2,
                    content: "${base}/examinesB/edit?id=" + data.id,
            ...
            if (obj.event === "del") {
                layer.confirm("你确定要删除该初检耐压么？", {btn: ['是的,我确定', '我再想想']},
                    function () {
                        $.post("${base}/examinesB/delete", {"id": data.id}, function (res) {
                            if (res.success) {
        ...
        var active = {
            addExaminesB: function () {
                var addIndex = layer.open({
                    title: "添加初检耐压",
                    type: 2,
                    content: "${base}/examinesB/add",
            ...
            removeDup: function () {
                ...
                layer.confirm(info, {btn: ['是的,我确定', '我再想想']},
                    function () {
                        ...
                        $.post("${base}/examinesB/removeDup", {"productSN": produceSN}, function (res) {
            ...
            exportExcel: function () {
                ...
                var downurl = "${base}/examinesB/exportExcel?s_planId=" + s_planId
